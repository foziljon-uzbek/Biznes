...
# Tayor Telegram akkauntlar (narxlar 10k-35k)
READY_ACCOUNTS = {
...
async def buy_virtual_number(callback: CallbackQuery):
    ...
    await bot.send_message(
        ...
        f"🌍 {country}\n"
        f"💵 {price:,} so'm\n\n"
        f"Nomerni qo'lda yuboring: /reply_{callback.from_user.id} <nomer>",
    )
    await callback.answer()


# ---------- 4-BO'LIM: Premium Telegram Nomerlar (5 davlat) ----------
